...
// The date that shall be deemed as end date to count the number of days of war. EIther the real end date of the war or the current date (today)
  ...
  return(
    <ul className="dateList">
      ...
      <li className="dateList__item">
        ...
        <p className="dateList__second-item dateList__caption">{getAdaptedSentenceIfLangIsUA(websiteLanguage, daysOfAggression)}</p>
      </li>
      <li className="dateList__item">
...
function getAdaptedSentenceIfLangIsUA(websiteLanguage, daysOfAggression) {
